...
No publicly available Windows Event Log dataset exists for smart grid SCADA or RTU
environments. Conti et al.\ \cite{conti2021survey} confirmed this absence in their
survey of ICS testbeds and datasets, attributing the gap to the sensitivity of
operational data and liability constraints faced by energy operators
\cite{nafees2023}. Synthetic generation is the established response to this barrier:
Goh et al.\ \cite{goh2016swat} constructed the SWaT testbed and generated controlled
attack scenarios precisely because real ICS attack traces were unavailable, producing
the dataset now standard in ICS security research. Chen et al.\ \cite{chen2022}
similarly synthesised APT-style Windows audit sequences when labelled host logs were
unavailable. Our generator follows this precedent, encoding MITRE ATT\&CK for ICS
attack patterns \cite{mitre2020attack} into realistic Windows Event Log sessions and
producing a labelled corpus reproducible without access to restricted operational
infrastructure.
